  ...
  return ( 
    ...
    > 
      ...
      <View style={styles.headingContainer}> 
        ...
        <Text style={styles.heading}>Welcome to Chef Christoffel's Menu</Text> 
      ...
      <View style={styles.buttonContainer}> 
        ...
        <TouchableOpacity 
          ...
          onPress={() => { 
            ...
            console.log('Continue as Guest pressed'); NavigationPreloadManager.navigate('GuestScreen')
        ...
        <TouchableOpacity 
          ...
          onPress={() => {  
            ...
            console.log('Login as Chef pressed'); NavigationPreloadManager.navigate('ChefScreen')
